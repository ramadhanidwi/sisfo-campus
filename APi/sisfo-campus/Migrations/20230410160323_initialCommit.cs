        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    faculty_code = table.Column<string>(type: "nchar(5)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_tb_m_majors", x => x.id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    major_code = table.Column<string>(type: "nchar(5)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    email = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    major_code = table.Column<string>(type: "nchar(5)", nullable: true),
                    course_code = table.Column<string>(type: "nchar(5)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    student_nim = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    course_code = table.Column<string>(type: "nchar(5)", nullable: false),
                    student_nim = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_tb_m_students_email_phone_number",
                table: "tb_m_students",
