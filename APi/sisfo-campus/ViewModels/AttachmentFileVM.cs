...
public class AttachmentFileVM : EntityBase
{
    [Display(Name = "SL")]
    [Required]
    ...
    public static implicit operator AttachmentFileVM(AttachmentFile _AttachmentFile)
    {
        return new AttachmentFileVM
        {
    ...
    public static implicit operator AttachmentFile(AttachmentFileVM vm)
    {
